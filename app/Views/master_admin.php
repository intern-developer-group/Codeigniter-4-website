...
<nav class="navbar navbar-expand-lg navbar-dark " style="
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="#" style="color : #d1b753;">Kangan Jewellers Admin</a>
    ...
    <div class="collapse navbar-collapse" id="navbarColor01">
      <ul class="navbar-nav me-auto">
       <!--  <li class="nav-item">
          <a class="nav-link active" href="http://localhost/KJ/public/DisplayUsers" style="color : #fff;">Registrarion_table
            <span class="visually-hidden" style="background-color : #fff;">(current)</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" href="http://localhost/KJ/public/register" style="color : #fff;">Registrarion_Form
            <span class="visually-hidden" style="background-color : #fff;">(current)</span>
          </a>
        </li> -->
        <li class="nav-item">
          <a class="nav-link active" href="http://localhost/KJ/public/ManageUsers" style="color : #fff;">Manage User
            <span class="visually-hidden" style="background-color : #fff;">(current)</span>
          </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
         ...
         <li class="nav-item">
          <a class="nav-link active" href="Manage_Products" style="color : #fff;">add product
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" href="worker_details" style="color : #fff;">Worker Details
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" href="ManageContact" style="color : #fff;">Contact Details
          </a>
        </li>
