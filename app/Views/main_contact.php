          ...
          <div class="card-body p-md-5">
            <div class="row justify-content-center">
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <form action="<?php echo base_url(); ?>/public/contact/ins" method="post" name="fome1" class="mt-4" >

                  <div class="d-flex flex-row align-items-center mb-4">
                    <i class="fas fa-user fa-lg me-3 fa-fw"></i>
                    <div class="form-outline flex-fill mb-0">
                      <input type="text" class="form-control" name="name" id="name" value="<?php if (isset($err)) : echo set_value(retain_value($err, 'name'));endif;  ?>"/>
                      <label class="form-label" for="form3Example1c">Enter Name</label>
                      <?php
                  if (isset($err)) {
                      if ($err->hasError('name')) {
                        ?> <div style="color: red;"> <?php
                          echo $err->getError('name');?></div><?php
                      }
                  } ?>
                    </div>
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    <i class="fas fa-lock fa-lg me-3 fa-fw"></i>
                    <div class="form-outline flex-fill mb-0">
                    <textarea class="textarea" placeholder="Type your text" type="text" name="massage" value="<?php if (isset($err)) : echo set_value(retain_value($err, 'massage'));endif;  ?>" style="height: 76px;width: 100%;"></textarea><br>
                      <label class="form-label" for="form3Example4c">Massage</label>
                      <?php
                  if (isset($err)) {
                      if ($err->hasError('massage')) {
                        ?> <div style="color: red;"> <?php
                          echo $err->getError('massage');?></div><?php
                      }
                  } ?>
                    </div>
                  </div> 
